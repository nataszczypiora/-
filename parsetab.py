...
_lr_productions = [
  ...
  ('program -> select_tree END','program',2,'p_program','SQLLexer.py',136),
  ('program -> program select_tree END','program',3,'p_program','SQLLexer.py',137),
  ('select_tree -> SELECT ARGS FROM_PARSE','select_tree',3,'p_select','SQLLexer.py',143),
  ('select_tree -> SELECT TOP_C FROM_PARSE','select_tree',3,'p_select','SQLLexer.py',144),
  ('select_tree -> SELECT ALL FROM_PARSE','select_tree',3,'p_select','SQLLexer.py',145),
  ('FROM_PARSE -> FROM ARGS','FROM_PARSE',2,'p_FROM_PARSE','SQLLexer.py',151),
  ('FROM_PARSE -> FROM ARGS ADDITIONAL_CLAUSES','FROM_PARSE',3,'p_FROM_PARSE','SQLLexer.py',152),
  ('ADDITIONAL_CLAUSES -> JOIN_C ADDITIONAL_CLAUSES','ADDITIONAL_CLAUSES',2,'p_ADDITIONAL_CLAUSES','SQLLexer.py',158),
  ('ADDITIONAL_CLAUSES -> WHERE_C ADDITIONAL_CLAUSES','ADDITIONAL_CLAUSES',2,'p_ADDITIONAL_CLAUSES','SQLLexer.py',159),
  ('ADDITIONAL_CLAUSES -> GROUP_BY_C ADDITIONAL_CLAUSES','ADDITIONAL_CLAUSES',2,'p_ADDITIONAL_CLAUSES','SQLLexer.py',160),
  ('ADDITIONAL_CLAUSES -> HAVING_C ADDITIONAL_CLAUSES','ADDITIONAL_CLAUSES',2,'p_ADDITIONAL_CLAUSES','SQLLexer.py',161),
  ('ADDITIONAL_CLAUSES -> ORDER_BY_C ADDITIONAL_CLAUSES','ADDITIONAL_CLAUSES',2,'p_ADDITIONAL_CLAUSES','SQLLexer.py',162),
  ('ADDITIONAL_CLAUSES -> LIMIT_C ADDITIONAL_CLAUSES','ADDITIONAL_CLAUSES',2,'p_ADDITIONAL_CLAUSES','SQLLexer.py',163),
  ('ADDITIONAL_CLAUSES -> OFFSET_C ADDITIONAL_CLAUSES','ADDITIONAL_CLAUSES',2,'p_ADDITIONAL_CLAUSES','SQLLexer.py',164),
  ('ADDITIONAL_CLAUSES -> JOIN_C','ADDITIONAL_CLAUSES',1,'p_ADDITIONAL_CLAUSES','SQLLexer.py',165),
  ('ADDITIONAL_CLAUSES -> WHERE_C','ADDITIONAL_CLAUSES',1,'p_ADDITIONAL_CLAUSES','SQLLexer.py',166),
  ('ADDITIONAL_CLAUSES -> GROUP_BY_C','ADDITIONAL_CLAUSES',1,'p_ADDITIONAL_CLAUSES','SQLLexer.py',167),
  ('ADDITIONAL_CLAUSES -> HAVING_C','ADDITIONAL_CLAUSES',1,'p_ADDITIONAL_CLAUSES','SQLLexer.py',168),
  ('ADDITIONAL_CLAUSES -> ORDER_BY_C','ADDITIONAL_CLAUSES',1,'p_ADDITIONAL_CLAUSES','SQLLexer.py',169),
  ('ADDITIONAL_CLAUSES -> LIMIT_C','ADDITIONAL_CLAUSES',1,'p_ADDITIONAL_CLAUSES','SQLLexer.py',170),
  ('ADDITIONAL_CLAUSES -> OFFSET_C','ADDITIONAL_CLAUSES',1,'p_ADDITIONAL_CLAUSES','SQLLexer.py',171),
  ('JOIN_C -> INNER JOIN_C','JOIN_C',2,'p_JOIN_C','SQLLexer.py',177),
  ('JOIN_C -> LEFT JOIN_C','JOIN_C',2,'p_JOIN_C','SQLLexer.py',178),
  ('JOIN_C -> RIGHT JOIN_C','JOIN_C',2,'p_JOIN_C','SQLLexer.py',179),
  ('JOIN_C -> FULL JOIN_C','JOIN_C',2,'p_JOIN_C','SQLLexer.py',180),
  ('JOIN_C -> OUTER JOIN_C','JOIN_C',2,'p_JOIN_C','SQLLexer.py',181),
  ('JOIN_C -> JOIN ARGS JOIN_C','JOIN_C',3,'p_JOIN_C','SQLLexer.py',182),
  ('JOIN_C -> ON VARIABLE','JOIN_C',2,'p_JOIN_C','SQLLexer.py',183),
  ('JOIN_C -> ON VARIABLE EQUAL VARIABLE','JOIN_C',4,'p_JOIN_C','SQLLexer.py',184),
  ('WHERE_C -> WHERE CONDITION','WHERE_C',2,'p_WHERE_C','SQLLexer.py',190),
  ('HAVING_C -> HAVING CONDITION','HAVING_C',2,'p_HAVING_C','SQLLexer.py',196),
  ('CONDITION -> VARIABLE OPERATOR MATCH','CONDITION',3,'p_CONDITION','SQLLexer.py',202),
  ('MATCH -> QUOTE ANY QUOTE','MATCH',3,'p_MATCH','SQLLexer.py',208),
  ('MATCH -> VARIABLE','MATCH',1,'p_MATCH','SQLLexer.py',209),
  ('MATCH -> EMPTY_STRING','MATCH',1,'p_MATCH','SQLLexer.py',210),
  ('GROUP_BY_C -> GROUP BY VARIABLE','GROUP_BY_C',3,'p_GROUP_BY_C','SQLLexer.py',216),
  ('INNER_SELECT_C -> L_PARENTIS SELECT ARGS FROM_PARSE R_PARENTIS','INNER_SELECT_C',5,'p_INNER_SELECT_C','SQLLexer.py',222),
  ('ORDER_BY_C -> ORDER BY VARIABLE','ORDER_BY_C',3,'p_ORDER_BY_C','SQLLexer.py',228),
  ('ORDER_BY_C -> ORDER BY VARIABLE DESC','ORDER_BY_C',4,'p_ORDER_BY_C','SQLLexer.py',229),
  ('ORDER_BY_C -> ORDER BY VARIABLE ASC','ORDER_BY_C',4,'p_ORDER_BY_C','SQLLexer.py',230),
  ('ORDER_BY_C -> ORDER BY NEWID_C','ORDER_BY_C',3,'p_ORDER_BY_C','SQLLexer.py',231),
  ('LIMIT_C -> LIMIT NUMBER','LIMIT_C',2,'p_LIMIT_C','SQLLexer.py',237),
  ('OFFSET_C -> OFFSET NUMBER','OFFSET_C',2,'p_OFFSET_C','SQLLexer.py',243),
  ('ARGS -> ARGS COMMA VARIABLE','ARGS',3,'p_ARG_LIST','SQLLexer.py',249),
  ('ARGS -> ARGS VARIABLE','ARGS',2,'p_ARG_LIST','SQLLexer.py',250),
  ('ARGS -> DISTINCT VARIABLE','ARGS',2,'p_ARG_LIST','SQLLexer.py',251),
  ('ARGS -> INNER_SELECT_C','ARGS',1,'p_ARG_LIST','SQLLexer.py',252),
  ('ARGS -> VARIABLE','ARGS',1,'p_ARG_LIST','SQLLexer.py',253),
  ('OPERATOR -> LESS','OPERATOR',1,'p_OPERATOR','SQLLexer.py',259),
  ('OPERATOR -> MORE','OPERATOR',1,'p_OPERATOR','SQLLexer.py',260),
  ('OPERATOR -> EQUAL','OPERATOR',1,'p_OPERATOR','SQLLexer.py',261),
  ('OPERATOR -> NOT_EQUAL','OPERATOR',1,'p_OPERATOR','SQLLexer.py',262),
  ('OPERATOR -> MORE_EQ','OPERATOR',1,'p_OPERATOR','SQLLexer.py',263),
  ('OPERATOR -> LESS_EQ','OPERATOR',1,'p_OPERATOR','SQLLexer.py',264),
  ('OPERATOR -> BETWEEN','OPERATOR',1,'p_OPERATOR','SQLLexer.py',265),
  ('OPERATOR -> LIKE','OPERATOR',1,'p_OPERATOR','SQLLexer.py',266),
  ('OPERATOR -> IN','OPERATOR',1,'p_OPERATOR','SQLLexer.py',267),
  ('OPERATOR -> REGEX','OPERATOR',1,'p_OPERATOR','SQLLexer.py',268),
  ('NEWID_C -> NEWID L_PARENTIS R_PARENTIS','NEWID_C',3,'p_NEWID_C','SQLLexer.py',274),
  ('TOP_C -> TOP NUMBER ARGS','TOP_C',3,'p_TOP_C','SQLLexer.py',280),
]
